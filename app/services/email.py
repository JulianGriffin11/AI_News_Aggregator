"""
================================================================================
🎯 SERVICE LAYER: SMTP UTILITY & HTML EMAIL BUILDER
================================================================================
Description:
  It manages structural data translation, parsing Markdown strings straight 
  into valid HTML containers, and packing content arrays for mail streams.
================================================================================
"""
...
def send_email(subject: str, body_text: str, body_html: str = None, recipients: list = None):
    ...
    if not MY_EMAIL or not APP_PASSWORD:
        raise ValueError("SMTP credentials missing from environment parameters")
...
def markdown_to_html(markdown_text: str) -> str:
    converted_html = markdown.markdown(markdown_text, extensions=['extra', 'nl2br'])
...
def send_email_to_self(subject: str, body: str):
    if not MY_EMAIL:
        raise ValueError("MY_EMAIL environment variable is not explicitly active")
    send_email(subject, body, recipients=[MY_EMAIL])


if __name__ == "__main__":
    send_email_to_self("Test Run from Engine Pipeline", "Database transaction script check verification.")