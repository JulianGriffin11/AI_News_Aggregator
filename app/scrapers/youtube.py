...
if __name__ == "__main__":
    ...
    # Print a short preview of the demo transcript instead of the whole text
    if transcript and transcript.text:
        preview = transcript.text[:200]
        if len(transcript.text) > 200:
            preview += "..."
        print("Demo transcript (preview):", preview)
    else:
        print("Demo transcript: (none)")
